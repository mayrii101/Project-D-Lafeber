...
describe("OrderAanmakenModal", () => {
  ...
  it("stuurt correcte data bij geldige invoer", async () => {
    ...
    fireEvent.change(screen.getByLabelText(/verwachte leverdatum/i), { target: { value: today } });
    fireEvent.change(screen.getByLabelText(/verwachte levertijd/i), { target: { value: "14:30" } });
  ...
  it("roept onSuccess niet aan als de API faalt", async () => {
    ...
    fireEvent.change(screen.getByLabelText(/verwachte leverdatum/i), { target: { value: today } });
    fireEvent.change(screen.getByLabelText(/verwachte levertijd/i), { target: { value: "10:00" } });
