...
namespace AzureSqlConnectionDemo.Tests.Services
{
  public class XmlToSqlImporterTests : IDisposable
  {
    ...
    [Fact]
    public async Task ImportFromXmlStringAsync_ShouldImportCustomersAndOrders()
    {
      var combinedXml = @"<?xml version=""1.0"" encoding=""utf-8""?>
<Root>
  <Customer>
    <Id>1</Id>
  ...
  <Order>
    ...
    <IsDeleted>false</IsDeleted>
      ...
      // Act
      await _importer.ImportFromXmlStringAsync(combinedXml);
