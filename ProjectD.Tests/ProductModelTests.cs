    ...
    public class ProductModelTests
    {
        ...
        public void Product_WithNegativePrice_IsInvalid()
        {
            var product = new Product
            {
                ...
                Price = -5.00 // Invalid due to [Range(0, double.MaxValue)]
            };
        ...
        public void Product_WithZeroPrice_IsValid()
        {
            ...
            Assert.Empty(results); // Price = 0 is allowed
        }
        ...
        public void Product_WithoutOptionalFields_IsStillValid()
        {
            var product = new Product
            {
                ...
                Price = 5.0,
                // SKU, Material, ExpirationDate etc. are optional
            };
        ...
        public void Product_ExpiredDate_InThePast_IsAllowed()
        {
            var product = new Product
            {
                ...
                Price = 1.0,
                ExpirationDate = DateTime.UtcNow.AddDays(-10) // Past date
            };

            var results = ValidateModel(product);

            Assert.Empty(results); // No built-in validation for ExpirationDate range
        }
    }
}
